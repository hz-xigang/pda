...
class TransferProductList extends StatelessWidget {
  const TransferProductList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ProductListView(
      ...
      onTapItem: (item) {
        final documentState = NotifierScope.read<TransferState>(context);
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TransferScope(
