...
class ShipProductList extends StatelessWidget {
  const ShipProductList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ProductListView(
      ...
      onTapItem: (item) {
        final documentState = NotifierScope.read<ShipState>(context);
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ShipScope(
