...
import 'package:hz_xg_pda/module_document_operation/components/document_operation_location_section.dart';
      ...
      children: [
        ...
        Expanded(
          child: SingleChildScrollView(
            child: Column(
              children: [
                const DocumentOperationOrderTypeSection(),
                const SizedBox(height: 16),
                const DocumentOperationDocumentSection(),
                if (state.isPrepOrder) ...[
                  const SizedBox(height: 16),
                  const DocumentOperationLocationSection(),
                ],
                const SizedBox(height: 16),
                const DocumentOperationTotalCount(),
                const SizedBox(height: 16),
                const DocumentOperationProductList(),
              ],
            ),
          ),
        ),
